...
class FeishuConfig(BaseModel):
    ...
    app_id: str = ""
    app_secret: str = ""
    allow_from: list[str] = Field(default_factory=list)  # Allowed Feishu open_ids
    default_litewrite_user_id: str = ""  # Litewrite user ID for project operations
...
class LitewriteConfig(BaseModel):
    """Litewrite integration configuration."""
...
class Config(BaseSettings):
    ...
    litewrite: LitewriteConfig = Field(default_factory=LitewriteConfig)
